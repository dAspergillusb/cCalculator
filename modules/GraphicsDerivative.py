...
from modules.graphics_derivative_parameters import (
    plot_width,
    plot_height,
...
class GraphicsDerivative:
    ...
    def get_func_derivative(self) -> None:
        async def _insert_result_into_func_der(derivative: ArrayDerivative | Derivative) -> None:
        ...
        async def _get_latex_equation_image(derivative: ArrayDerivative | Derivative) -> None:
            # equation_image: GetLatexEquationImage =
            await GetLatexEquationImage(equation=derivative)
        ...
        async def _main_() -> None:
            derivative: ArrayDerivative | Derivative = diff(get_value(self.func_to_der), 'x')
            await gather(
